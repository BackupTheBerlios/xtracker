...
public class ToggleProjectSelectableStateAction extends BaseAction {
	private Logger	logger	= LogManager.getLogger(ToggleProjectSelectableStateAction.class);

	public ToggleProjectSelectableStateAction() {
		super();
	}
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse reponse) throws HibernateException {
		...
		project.setSelectable(!project.isSelectable());
