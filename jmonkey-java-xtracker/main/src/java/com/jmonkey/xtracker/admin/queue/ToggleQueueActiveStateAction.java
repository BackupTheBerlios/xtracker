...
public class ToggleQueueActiveStateAction extends BaseAction {
	private Logger	logger	= LogManager.getLogger(ToggleQueueActiveStateAction.class);

	public ToggleQueueActiveStateAction() {
		super();
	}
