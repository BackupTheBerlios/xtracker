...
public class ToggleStatusActiveStateAction extends BaseAction {
	private Logger	logger	= LogManager.getLogger(ToggleStatusActiveStateAction.class);

	public ToggleStatusActiveStateAction() {
		super();
	}
