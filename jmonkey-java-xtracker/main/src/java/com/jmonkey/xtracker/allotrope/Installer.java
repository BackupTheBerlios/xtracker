...
//
//		Disposition info = new Disposition("Information Request", "#FFFFB0".toUpperCase(), created);
//		info.setId(6);
//		info.setActive(true);
//		info.setSelectable(true);
//
//		Disposition suggestion = new Disposition("Suggestion", "#FFA0A0".toUpperCase(), created);
//		suggestion.setId(7);
//		suggestion.setActive(true);
//		suggestion.setSelectable(true);
//
//		Disposition usage = new Disposition("Usage Problem", "#C8C8FF".toUpperCase(), created);
//		usage.setId(8);
...
//
//		Status acknowledgedStatus = new Status("Acknowledged", "#C0C0C0", created);
