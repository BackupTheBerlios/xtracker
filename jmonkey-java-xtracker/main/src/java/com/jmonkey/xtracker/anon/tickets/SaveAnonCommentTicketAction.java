...
public class SaveAnonCommentTicketAction extends BaseAction {
	private Logger	logger	= LogManager.getLogger(SaveAnonCommentTicketAction.class);

	public SaveAnonCommentTicketAction() {
		super();
	}
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse reponse) throws Exception {
		...
		AnonTicketMessageForm ticketMessageForm = (AnonTicketMessageForm) form;
	...
	private void addTicketHistory(HttpServletRequest request, AnonTicketMessageForm form, Ticket ticket) throws HibernateException {
