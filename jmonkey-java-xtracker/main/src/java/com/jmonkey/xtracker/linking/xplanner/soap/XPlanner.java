...
public interface XPlanner extends java.rmi.Remote {
    ...
    public org.xplanner.soap.TaskData[] getCurrentTasksForPerson(int personId) throws java.rmi.RemoteException, com.technoetic.xplanner.db.QueryException;
    public org.xplanner.soap.TaskData[] getPlannedTasksForPerson(int personId) throws java.rmi.RemoteException, com.technoetic.xplanner.db.QueryException;
