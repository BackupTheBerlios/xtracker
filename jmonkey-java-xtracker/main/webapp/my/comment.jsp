...
<layout:html layout="false" key="page.title.my">
	...
	<html:form action="/my/saveComment">
			<html:hidden property="id"/>
			<bean:message key="view.panel.label.ticket.add.comment"/> #<bean:write name="ticketMessageForm" property="id" />
			<table cellspacing="0" cellpadding="0" border="0" class="boxblue">
			<tr>
